<template>
    <div class="product-detail">
    	<div class="clearfix section-header">
    		...
    		<strong class="f_r share-icon"></strong>
    	</div>
    	...
    	<div class="padding_common buyer-said">
    		<div class="buyer-area-person">
    			<div class="flexbox">
    				<i class="buyer-area-person-tip"></i>
    				<div class="buyer-area-person-icon">
    					<img src="~src/images/person-icon.png" alt="">
    				</div>
    				<span class="buyer-name">摩奇复活核心团队</span>
    			</div>
