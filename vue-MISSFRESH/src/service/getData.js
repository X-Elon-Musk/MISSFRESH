...
// 编辑收货地址
export const updateAddressAxios=(id, address_1, address_2, address_detail, area, city, code, full_address, lat_lng, name, phone_number, province, tag) => axios('/customer/updateAddress', {
    id,
    address_1,
    address_2,
    address_detail,
